...
enum class SHADER_TYPE : uint8 /* Shader Type */
{
	DEFERRED,
	FORWARD,
	LIGHTING,
...
enum class RASTERIZER_TYPE : uint8 /* Rasterizer Type */
{
	CULL_NONE,
	CULL_FRONT,
	CULL_BACK,
...
enum class DEPTH_STENCIL_TYPE : uint8 /* Depth Stencil Type */
{
	LESS,
	LESS_EQUAL,
	GREATER,
...
enum class BLEND_TYPE : uint8 /* Blend Type */
{
	DEFAULT,
	ALPHA_BLEND,
	ONE_TO_ONE_BLEND,
...
public:
	...
	void Set_Rasterize_Type(RASTERIZER_TYPE type) { _info.rasterizerType = type; }
