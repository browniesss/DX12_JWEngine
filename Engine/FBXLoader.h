...
struct FbxMaterialInfo /* Fbx Material Info */
{
	Vec4			diffuse;
	Vec4			ambient;
	Vec4			specular;
...
struct FbxMeshInfo /* Fbx Mesh Info */
{
	wstring								name;
...
struct FbxKeyFrameInfo /* Fbx Key Frame Info */
{
	FbxAMatrix  matTransform;
	double		time;
};

struct FbxBoneInfo /* Fbx Bone Info */
{
	wstring					boneName;
	int32					parentIndex;
...
struct FbxAnimClipInfo /* Fbx Anim Clip Info */
{
	wstring			name;
	FbxTime			startTime;
	FbxTime			endTime;
